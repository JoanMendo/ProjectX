...
public class ApiManager : MonoBehaviour
{
    ...
    public IEnumerator DeleteUser(System.Action<bool, string> onComplete)
    {
        string url = $"{baseUrl}/eliminar-usuario";
        string accessToken = SecureStorage.LoadAccessToken();
        ...
        using (UnityWebRequest request = new UnityWebRequest(url, "DELETE"))
        {
            ...
            try
            {
                ...
                // Si la eliminación fue exitosa, limpiamos los datos locales
                SecureStorage.ClearAllData();
                isAutoRefreshActive = false;
                StopAllCoroutines();
